...
def score_state(s,cfg:SRIConfig=SRIConfig(),dataset=''):
    ...
    # A current prepared state must contain the selected adjacency-response result.
    # A missing prepared result is an error; no scoring fallback is used.
